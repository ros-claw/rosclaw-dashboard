...
from rosclaw_dashboard.models.schemas import AcceptanceReport, AcceptanceReportResponse
from rosclaw_dashboard.services.report_generator import generate_acceptance_report, get_report_path
...
def get_report(run_id: str):
    ...
    with path.open("r", encoding="utf-8") as f:
        data = json.load(f)
    from rosclaw_dashboard.models.schemas import AcceptanceReport
